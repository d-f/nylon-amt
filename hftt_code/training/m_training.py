...
if __name__ == '__main__':
    ...
    parser.add_argument('-config', help='config json file', default='C:\\personal_ML\\nylon_hftt\\code\\hftt_code\\corpus\\config.json')
    parser.add_argument('-d_out', help='parameter directory', default='C:\\personal_ML\\nylon_hftt\\output\\')
    parser.add_argument('-d_dataset', help='dataset directory', default='C:\\personal_ML\\nylon_hftt\\processed_data\\dataset\\')
    ...
    d_dataset = Path(args.d_dataset.rstrip('/'))
    if args.n_div_train <= 1:
        dataset_train = dataset.MyDataset(d_dataset.joinpath('feature').joinpath('train.pkl'),
                                          d_dataset.joinpath('label_onset').joinpath('train.pkl'),
                                          d_dataset.joinpath('label_offset').joinpath('train.pkl'),
                                          d_dataset.joinpath('label_mpe').joinpath('train.pkl'),
                                          d_dataset.joinpath('label_velocity').joinpath('train.pkl'),
                                          d_dataset.joinpath('idx').joinpath('train.pkl'),
                                          config,
                                          args.n_slice)
    ...
    if args.n_div_valid <= 1:
        dataset_valid = dataset.MyDataset(d_dataset.joinpath('feature').joinpath('val.pkl'),
                                          d_dataset.joinpath('label_onset').joinpath('val.pkl'),
                                          d_dataset.joinpath('label_offset').joinpath('val.pkl'),
                                          d_dataset.joinpath('label_mpe').joinpath('val.pkl'),
                                          d_dataset.joinpath('label_velocity').joinpath('val.pkl'),
                                          d_dataset.joinpath('idx').joinpath('val.pkl'),
                                          config,
                                          args.n_slice)
    ...
    if (args.valid_test is True) and (args.n_div_test <= 1):
        dataset_test = dataset.MyDataset(d_dataset.joinpath('feature').joinpath('test.pkl'),
                                          d_dataset.joinpath('label_onset').joinpath('test.pkl'),
                                          d_dataset.joinpath('label_offset').joinpath('test.pkl'),
                                          d_dataset.joinpath('label_mpe').joinpath('test.pkl'),
                                          d_dataset.joinpath('label_velocity').joinpath('test.pkl'),
                                          d_dataset.joinpath('idx').joinpath('test.pkl'),
                                         config,
                                         args.n_slice)
